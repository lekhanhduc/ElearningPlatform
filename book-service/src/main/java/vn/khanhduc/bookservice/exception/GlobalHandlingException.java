...
import vn.khanhduc.bookservice.dto.response.ErrorResponse;
...
public class GlobalHandlingException {
    ...
    public ResponseEntity<ErrorResponse> handleBookException(BookException exception, HttpServletRequest request) {
        ErrorResponse errorResponse = ErrorResponse.builder()
                .timestamp(new Date())
                .status(HttpStatus.BAD_REQUEST.value())
