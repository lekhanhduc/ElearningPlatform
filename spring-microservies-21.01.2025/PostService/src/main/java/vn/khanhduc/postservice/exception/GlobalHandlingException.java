...
import vn.khanhduc.postservice.dto.response.ErrorResponse;
...
public class GlobalHandlingException {
    ...
    public ResponseEntity<ErrorResponse> handlePostException(PostException exception, HttpServletRequest request) {
        ErrorResponse errorResponse = ErrorResponse.builder()
                .timestamp(new Date())
                .status(HttpStatus.BAD_REQUEST.value())
