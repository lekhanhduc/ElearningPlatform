...
public class AuthController {
    ...
    ResponseData<SignInResponse> signIn(@RequestBody @Valid SignInRequest request, HttpServletResponse response) {
        ...
        addRefreshToCookie(result.getRefreshToken(), response);
    ...
    ResponseData<SignInResponse> signInGoogle(@RequestParam String code, HttpServletResponse response) {
        var result = authenticationService.signInWithGoogle(code);
        addRefreshToCookie(result.getRefreshToken(), response);
